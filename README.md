...
<p align="center">
  <a href="https://github.com/Hridoy0016/Jolly-Roger/fork">
    <img src="https://img.shields.io/github/forks/Hridoy0016/Jolly-Roger?label=Fork&style=social">
    
    
  <a href="https://github.com/Hridoy0016/Jolly-Roger/stargazers">
    <img src="https://img.shields.io/github/stars/Hridoy0016/Jolly-Roger?style=social">
  </a>
<p align="center">
<a href="https://github.com/Hridoy0016/Jolly-Roger"><img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2FHridoy0016%2FOne-piece-MD&count_bg=%23FFA305&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=People+Visited&edge_flat=false)](https://hits.seeyoufarm.com" width="150px" /></a>
</p>
...
<p align="center">
    <a href="https://app.koyeb.com/apps/deploy?type=docker&image=quay.io/Hridoy0016/Atlas:main&env[PORT]=8000&env[PREFIX]=-&&env[MONGODB]=mongodb+srv://fantox001:zjmbvgwr52@cluster0.qh05pl9.mongodb.net/?retryWrites=true&w=majority&&env[SESSION_ID]=enterYourSession&&env[MODS]=918101187835,919735940276&&env[TENOR_API_KEY]=AIzaSyCyouca1_KKy4W_MG1xsPzuku5oa8W358c&&env[PACKNAME]=Miku-Nakano&&env[AUTHOR]=Hridou&&name=Night">
...
<p align="center" >
    <a href="https://heroku.com/deploy?template=https://github.com/Hridoy0016/Atlas">
...
- [Fork Main Repo](https://github.com/Hridoy0016/Jolly-Rogger/fork)
- Create a MongoDB URL. Need help? Watch this short 1 minute [Video Guide](https://youtube.com/shorts/pIHvoXkwmq4?feature=share) for MongoDB URL.
- Click on `Deploy to Heroku` button ( `For those who didn't modified bot.`). In other case (`For those who modified bot.`) edit README.md file and chage the repo link of Repl.it deply button from `https://github.com/Hridoy0016/One-piece` to your fork URL `https://github.com/<Your GitHub Username>/<Your Night fork repo name>` also got to `app.json` and change `Website` ans `Repository` link from my link to your link. Then click on `Deploy to Heroku` button.
...
KEY | VALUE
-- | --
MODS | Phone numbers in this format (`91810187876`,`9258973489`) without `+` or `SPACE`.
MONGODB | Your MongoDB URL
SESSION_ID | Any random value (`EX: gwfdrte5678`) and `keep it copied`.
PREFIX | Any single special character except `@` (`Ex: . or / or * or , etc.`)
TENOR_API_KEY | Your tenor API key if you have. Or use this public one: `AIzaSyCyouca1_KKy4W_MG1xsPzuku5oa8W358c`
...
KEY | VALUE
-- | --
MODS | Phone numbers in this format (`91810187876`,`92589786389`) without `+` or `SPACE`.
MONGODB | Your MongoDB URL
SESSION_ID | Any random value (`EX: gwfdrte5678`) and `keep it copied`.
PREFIX | Any single special character except `@` (`Ex: . or / or * or , etc.`)
TENOR_API_KEY | Your tenor API key if you have. Or use this public one: `AIzaSyCyouca1_KKy4W_MG1xsPzuku5oa8W358c`
...
- [Download Updated code](https://github.com/Hridoy0016/Jolly-Roger/archive/refs/heads/main.zip) from Main GitHub Repo or Download from your Forked Repo.
...
#### 📌 To start bot again ( While you are inside Night folder {use `cd Night` to get inside the folder} )
...
```
https://gist.githubusercontent.com/FantoX001/b818960e024c541e155f948db34a2da2/raw/f6771fbd4c615a64eafb92d53e7627276f20167a/audio-edit.js/audio-edit.js
```
💡 [Plug-in Source Code ↗](https://gist.github.com/FantoX001/b818960e024c541e155f948db34a2da2/f6771fbd4c615a64eafb92d53e7627276f20167a)
<br><br>
...
**🧲️ Plug-in installation url:** 
```
https://gist.githubusercontent.com/Hridoy0016/6ceb0c0a7a92165bb6a7318ece5aea9c/raw/79ad032f7a262cbf4b1fa307e75e831120f3869c/Chat-Gpt.js
```
💡 [Plug-in Source Code ↗](https://gist.github.com/Hridoy0016/6ceb0c0a7a92165bb6a7318ece5ae9c)
<br><br>
...
<p align="center" >
<a href="https://cutt.ly/LwusHGz2/NightSupportStrict"><img src="https://img.shields.io/badge/Join Group-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" width="140px">
</a>
</p>
...
- [Hridoy APIs ( For NSFW )](https://fantox-api.vercel.app/#)
...
- 100+ NSFW commands ( Using my own API ). Visit: [My API Page](https://Hridoy-api.vercel.app) for more info. 
...
Owner of Jolly Roger | Ideas, Testing, Co-developer|
<a href="https://github.com/Rikuodada"><img src="https://github.com/Rikuodada.png?size=100" width="100" height="100"></a> | [![Rishi](https://github.com/Rl1ys.png?size=100)](https://github.com/Rl1ys)
---|---
[Manab/Mp](https://github.com/Rikuodada)  | [Rishi/Sungur🐖](https://github.com/Rl1ys)
| Useless worker | Ideas, Testing|
